...
it: {
    ...
    'actions.markReleased': 'Marca come rilasciati...',
    'actions.purgeReleased': 'Pulisci coda rilasci...',
    ...
    // Sblocca i miei lock (QuickPick)
    'rel.now': 'adesso',
    'rel.noMyLocks': 'VibeSync: nessun lock attivo a tuo nome',
    'rel.unlockSelectPlaceholder': 'Tutti pre-selezionati. Deseleziona quelli che vuoi mantenere lockati.',
    'rel.unlockMyLocksTitle': 'VibeSync — Sblocca i miei lock ({0} attivi)',
    'rel.unlockCancelled': 'VibeSync: sblocco annullato',
    'rel.unlockNoneSelected': 'VibeSync: nessun lock selezionato — niente da sbloccare',
    'rel.unlockedAll': 'VibeSync: {0} lock sbloccati',
    'rel.unlockedSomeKept': 'VibeSync: {0} lock sbloccati, {1} mantenuti',
    // Mark as released (senza copiare)
    'rel.selectMarkReleased': 'Seleziona file da marcare come gia\' rilasciati (no copia)',
    'rel.markReleasedTitle': 'VibeSync — Marca come rilasciati',
    'rel.markedReleased': 'VibeSync: {0} file marcati come rilasciati ({1} gia\' rilasciati)',
    'rel.markReleasedError': 'VibeSync: errore mark released — {0}',
    // Purge released (cleanup queue)
    'rel.noReleasedToPurge': 'VibeSync: nessuna voce gia\' rilasciata da pulire',
    'rel.purgeAll': 'Tutte le voci rilasciate',
    'rel.purgeOlderThan': 'Solo piu\' vecchie di {0} giorni',
    'rel.purgeChoosePlaceholder': 'Quali voci rilasciate vuoi rimuovere?',
    'rel.purgeTitle': 'VibeSync — Pulisci coda rilasci',
    'rel.purgeConfirmAll': 'Rimuovo {0} voci gia\' rilasciate dalla queue?',
    'rel.purgeConfirmFiltered': 'Rimuovo le voci rilasciate da almeno {0} giorni?',
    'rel.purgeConfirmYes': 'Sì, rimuovi',
    'rel.purgeDone': 'VibeSync: rimosse {0} voci, {1} pendenti restano in coda',
    'rel.purgeError': 'VibeSync: errore purge — {0}',
    ...
    'sync.confirmCopy': 'VibeSync Sync: rilasciare {0} file su GitHub Desktop? (copia + sblocca lock + marca coda)',
    'sync.copy': 'Rilascia',
    'sync.filesCopied': 'VibeSync Sync: {0} file copiati su GitHub Desktop e lock rilasciati',
    'sync.filesReleased': 'VibeSync Sync: {0} file rilasciati ({1} lock sbloccati, {2} marcati nella coda)',
    'sync.copyWithErrors': 'VibeSync Sync: {0} copiati, {1} errori',
    'sync.confirmCopyFromGit': 'VibeSync Sync: copiare {0} file da GitHub Desktop nella working copy? (sovrascriverà le versioni locali)',
    'sync.copyFromGitLabel': 'Copia da Git',
    'sync.filesCopiedFromGit': 'VibeSync Sync: {0} file copiati da GitHub Desktop nella working copy',
    'sync.copyingFromGitN': 'Copia da Git di {0} file in corso...',
    'sync.copyFromGitBtn': '⬇ Copia da Git ({0})',
    'sync.githubOnlyFiles': 'Solo su Git',
    'sync.modifiedToGitSection': 'File Modificati — locale più recente',
    'sync.modifiedFromGitSection': 'File Modificati — Git più recente',
    'sync.githubOnlySection': 'File presenti solo su Git',
    'sync.directionToGit': '→ verso Git Desktop',
    'sync.directionFromGit': '← da Git Desktop',
    'sync.selectAllToGit': 'Seleziona tutto verso Git',
    'sync.selectAllFromGit': 'Seleziona tutto da Git',
    'sync.filesSelectedSplit': '{0} verso Git · {1} da Git',
    'sync.diffTitle': '{0}  (Locale tuo ← → GitHub Desktop)',
    'sync.diffNavTip': 'Tip: usa F7 / Shift+F7 per spostarti tra le differenze (oppure le frecce ⬆⬇ in alto a destra del diff editor).',
    ...
    'sync.copySelected': 'Rilascia selezionati ({0})',
...
en: {
    ...
    'actions.markReleased': 'Mark as released...',
    'actions.purgeReleased': 'Clean release queue...',
    ...
    // Unlock my locks (QuickPick)
    'rel.now': 'now',
    'rel.noMyLocks': 'VibeSync: no active locks under your name',
    'rel.unlockSelectPlaceholder': 'All pre-selected. Deselect the ones you want to keep locked.',
    'rel.unlockMyLocksTitle': 'VibeSync — Unlock my locks ({0} active)',
    'rel.unlockCancelled': 'VibeSync: unlock cancelled',
    'rel.unlockNoneSelected': 'VibeSync: no locks selected — nothing to unlock',
    'rel.unlockedAll': 'VibeSync: {0} locks released',
    'rel.unlockedSomeKept': 'VibeSync: {0} locks released, {1} kept',
    // Mark as released (no copy)
    'rel.selectMarkReleased': 'Select files to mark as already released (no copy)',
    'rel.markReleasedTitle': 'VibeSync — Mark as released',
    'rel.markedReleased': 'VibeSync: {0} files marked as released ({1} already released)',
    'rel.markReleasedError': 'VibeSync: mark released error — {0}',
    // Purge released (cleanup queue)
    'rel.noReleasedToPurge': 'VibeSync: no released entries to purge',
    'rel.purgeAll': 'All released entries',
    'rel.purgeOlderThan': 'Only older than {0} days',
    'rel.purgeChoosePlaceholder': 'Which released entries to remove?',
    'rel.purgeTitle': 'VibeSync — Clean release queue',
    'rel.purgeConfirmAll': 'Remove {0} already-released entries from the queue?',
    'rel.purgeConfirmFiltered': 'Remove entries released at least {0} days ago?',
    'rel.purgeConfirmYes': 'Yes, remove',
    'rel.purgeDone': 'VibeSync: removed {0} entries, {1} pending remain in queue',
    'rel.purgeError': 'VibeSync: purge error — {0}',
    ...
    'sync.confirmCopy': 'VibeSync Sync: release {0} files to GitHub Desktop? (copy + unlock + mark queue)',
    'sync.copy': 'Release',
    'sync.filesCopied': 'VibeSync Sync: {0} files copied to GitHub Desktop and locks released',
    'sync.filesReleased': 'VibeSync Sync: {0} files released ({1} locks unlocked, {2} marked in queue)',
    'sync.copyWithErrors': 'VibeSync Sync: {0} copied, {1} errors',
    'sync.confirmCopyFromGit': 'VibeSync Sync: copy {0} files from GitHub Desktop into working copy? (will overwrite local versions)',
    'sync.copyFromGitLabel': 'Copy from Git',
    'sync.filesCopiedFromGit': 'VibeSync Sync: {0} files copied from GitHub Desktop into working copy',
    'sync.copyingFromGitN': 'Copying {0} files from Git...',
    'sync.copyFromGitBtn': '⬇ Copy from Git ({0})',
    'sync.githubOnlyFiles': 'Git-only',
    'sync.modifiedToGitSection': 'Modified — local newer',
    'sync.modifiedFromGitSection': 'Modified — Git newer',
    'sync.githubOnlySection': 'Files only on Git',
    'sync.directionToGit': '→ to Git Desktop',
    'sync.directionFromGit': '← from Git Desktop',
    'sync.selectAllToGit': 'Select all to Git',
    'sync.selectAllFromGit': 'Select all from Git',
    'sync.filesSelectedSplit': '{0} to Git · {1} from Git',
    'sync.diffTitle': '{0}  (Your local ← → GitHub Desktop)',
    'sync.diffNavTip': 'Tip: use F7 / Shift+F7 to navigate between differences (or the ⬆⬇ arrows in the top-right of the diff editor).',
    ...
    'sync.copySelected': 'Release selected ({0})',
