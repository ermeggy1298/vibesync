...
- `src/i18n.ts` — All translations (add new languages here!)
- `src/searchPanel.ts` — Chat search & projects UI
- `src/syncPanel.ts` — Sync dashboard UI
